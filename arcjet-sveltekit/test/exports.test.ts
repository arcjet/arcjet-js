...
test('`@arcjet/sveltekit`: should expose exactly the api surface of "."', async function () {
...
test('`@arcjet/sveltekit`: should publish every value of "." as a value', async function () {
  const module = await import("@arcjet/sveltekit");
...
test("`@arcjet/sveltekit`: should not republish another package's internals", async function () {
