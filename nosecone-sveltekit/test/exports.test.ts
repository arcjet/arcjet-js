...
test('`@nosecone/sveltekit`: should expose exactly the api surface of "."', async function () {
...
test('`@nosecone/sveltekit`: should publish every value of "." as a value', async function () {
  const module = await import("@nosecone/sveltekit");
...
test("`@nosecone/sveltekit`: should not republish another package's internals", async function () {
