...
## [1.1.1](https://github.com/arcjet/arcjet-js/compare/v1.1.0...@arcjet/redact-v1.1.1) (2026-02-06)
...
* The following workspace dependencies were updated
  * dependencies
    * @arcjet/redact-wasm bumped from 1.1.0 to 1.1.1
  * devDependencies
    * @arcjet/eslint-config bumped from 1.1.0 to 1.1.1
    * @arcjet/rollup-config bumped from 1.1.0 to 1.1.1
