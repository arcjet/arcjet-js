...
## [1.1.0](https://github.com/arcjet/arcjet-js/compare/v1.1.0-rc...@arcjet/redact-v1.1.0) (2026-02-05)
...
* The following workspace dependencies were updated
  * dependencies
    * @arcjet/redact-wasm bumped from 1.1.0-rc to 1.1.0
  * devDependencies
    * @arcjet/eslint-config bumped from 1.1.0-rc to 1.1.0
    * @arcjet/rollup-config bumped from 1.1.0-rc to 1.1.0

## [1.1.0-rc](https://github.com/arcjet/arcjet-js/compare/v1.0.0...@arcjet/redact-v1.1.0-rc) (2026-02-03)
...
* The following workspace dependencies were updated
  * dependencies
    * @arcjet/redact-wasm bumped from 1.0.0 to 1.1.0-rc
  * devDependencies
