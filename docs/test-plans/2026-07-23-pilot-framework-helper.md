...
`arcjet-guard/src/vercel-ai/v7/*.test.ts` (74 tests within a 462-test suite) plus
...
- `arcjet-guard` automated gate green: `cd arcjet-guard && npm run test-unit` → 462 pass, 0 fail.
