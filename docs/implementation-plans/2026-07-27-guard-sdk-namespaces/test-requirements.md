...
Of the 36 automated: 25 have a unit leg (2 of those with an additional integration leg), 3 are packaging-only (AC2.2, AC2.3, AC3.2 — Phase 6 Task 2), 1 is integration-only (AC7.2), and the remaining 8 are shell-check gates per §3.
