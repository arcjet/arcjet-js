function instantiate(
  ...
  const module0 = getCoreModule(
    "arcjet_analyze_bindings_redact.component.core.wasm",
  );
  const module1 = getCoreModule(
    "arcjet_analyze_bindings_redact.component.core2.wasm",
  );
  const module2 = getCoreModule(
    "arcjet_analyze_bindings_redact.component.core3.wasm",
  );

  const { debug } = imports["arcjet:sensitive-info/logger"];
  const { detect } =
    imports["arcjet:sensitive-info/sensitive-information-identifier"];
