//#region wasm/arcjet_analyze_bindings_redact.component.js
function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
	...
	let gen = (function* init() {
		...
		function trampoline0(arg0, arg1, arg2) {
			...
			var vec5 = detectSensitiveInfo(result1);
		...
		function trampoline1(arg0, arg1, arg2, arg3, arg4, arg5) {
			...
			switch (arg0) {
				case 0:
					...
					break;
				case 1:
					variant1 = { tag: "phone-number" };
					break;
				case 2:
					variant1 = { tag: "ip-address" };
					break;
				case 3:
					variant1 = { tag: "credit-card-number" };
					break;
				case 4:
					var ptr0 = arg1;
					var len0 = arg2;
					variant1 = {
						tag: "custom",
						val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0))
					};
					break;
			...
			var variant4 = redactSensitiveInfo(variant1, result2);
			if (variant4 === null || variant4 === void 0) dataView(memory0).setInt8(arg5 + 0, 0, true);
			else {
				const e = variant4;
		...
		({exports: exports1} = yield instantiateCore(yield module0, { "arcjet:redact/custom-redact": {
			...
			for (let i = 0; i < len11; i++) {
				...
				switch (dataView(memory0).getUint8(base + 24, true)) {
					case 0:
						...
						break;
					case 1:
						variant10 = { tag: "phone-number" };
						break;
					case 2:
						variant10 = { tag: "ip-address" };
						break;
					case 3:
						variant10 = { tag: "credit-card-number" };
						break;
					case 4:
	...
	function runNext(value) {
		try {
			...
			if (done) if (resolve) resolve(value);
			else return value;
