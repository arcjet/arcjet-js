...
test("`@arcjet/astro`: should expose the documented export paths", async function () {
...
test('`@arcjet/astro`: should expose the value exports of "."', async function () {
  const module = await import("@arcjet/astro");
...
test('`@arcjet/astro`: should expose exactly the api surface of "."', async function () {
...
test('`@arcjet/astro`: should publish every value of "." as a value', async function () {
  const module = await import("@arcjet/astro");
...
test("`@arcjet/astro`: should not republish another package's internals", async function () {
