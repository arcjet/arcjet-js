...
test("`@arcjet/sprintf`: should expose the documented export paths", async function () {
...
test('`@arcjet/sprintf`: should expose the value exports of "."', async function () {
  const module = await import("@arcjet/sprintf");

  assert.deepEqual(new Set(Object.keys(module)), new Set(["default", "sprintf"]));
});

test('`@arcjet/sprintf`: should expose exactly the api surface of "."', async function () {
...
test('`@arcjet/sprintf`: should publish every value of "." as a value', async function () {
  const module = await import("@arcjet/sprintf");
...
test("`@arcjet/sprintf`: should not republish another package's internals", async function () {
