...
test('`@arcjet/fastify`: should expose exactly the api surface of "."', async function () {
...
test("`@arcjet/fastify`: should not republish another package's internals", async function () {
