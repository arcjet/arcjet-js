...
test("`@arcjet/ip` public API", async function (t) {
  ...
  await t.test('should expose the value exports of "./cloudflare"', async function () {
  ...
  await t.test('should expose exactly the api surface of "./cloudflare"', async function () {
    const [declaration, documented] = await Promise.all([
  ...
  await t.test('should publish every value of "./cloudflare" as a value', async function () {
    const module = await import("@arcjet/ip/cloudflare");
  ...
  await t.test('should expose "./cloudflare.js" as an alias of "./cloudflare"', async function () {
