...
test("`@arcjet/duration`: should expose the documented export paths", async function () {
...
test('`@arcjet/duration`: should expose the value exports of "."', async function () {
  const module = await import("@arcjet/duration");

  assert.deepEqual(new Set(Object.keys(module)), new Set(["parse"]));
});

test('`@arcjet/duration`: should expose exactly the api surface of "."', async function () {
...
test('`@arcjet/duration`: should publish every value of "." as a value', async function () {
  const module = await import("@arcjet/duration");
...
test("`@arcjet/duration`: should not republish another package's internals", async function () {
