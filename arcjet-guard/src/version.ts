...
export const VERSION = "0.1.0-experimental.1";
 ...
 *
 * Output examples:
arcjet-guard-js/0.1.0-experimental.1 (node/22.22.1; Node.js/22)"
 * - `"arcjet-guard-js/0.1.0-experimental.1 (bun/1.2.19; Bun/1.2.19)"
 * - `"arcjet-guard-js/0.1.0-experimental.1 (deno/2.4.2; Deno/2.4.2)"
 * - `"arcjet-guard-js/0.1.0-experimental.1 (workerd; Cloudflare-Workers)"
 * - `"arcjet-guard-js/0.1.0-experimental.1 (edge-light)"
 * - `"arcjet-guard-js/0.1.0-experimental.1"
 *
