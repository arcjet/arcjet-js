...
export class ArcjetAllowDecision extends ArcjetDecision {
    // Warning: (ae-forgotten-export) The symbol "ArcjetDecisionInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetBotReason extends ArcjetReason {
    // Warning: (ae-forgotten-export) The symbol "ArcjetBotReasonInit" needs to be exported by the entry point index.d.ts
...
export type ArcjetContext = {
    ...
    cache: Cache_2<ArcjetCacheEntry>;
...
export abstract class ArcjetDecision {
    // Warning: (ae-forgotten-export) The symbol "ArcjetDecisionInitAbstract" needs to be exported by the entry point index.d.ts
...
export class ArcjetEmailReason extends ArcjetReason {
    // Warning: (ae-forgotten-export) The symbol "ArcjetEmailReasonInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetErrorDecision extends ArcjetDecision {
    // Warning: (ae-forgotten-export) The symbol "ArcjetErrorDecisionInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetFilterReason extends ArcjetReason {
    ...
    // Warning: (ae-forgotten-export) The symbol "ArcjetFilterReasonInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetIpDetails {
    // Warning: (ae-forgotten-export) The symbol "ArcjetIpDetailsInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetPromptInjectionReason extends ArcjetReason {
    // Warning: (ae-forgotten-export) The symbol "ArcjetPromptInjectionReasonInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetRateLimitReason extends ArcjetReason {
    // Warning: (ae-forgotten-export) The symbol "ArcjetRateLimitReasonInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetRuleResult {
    // Warning: (ae-forgotten-export) The symbol "ArcjetRuleResultInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetSensitiveInfoReason extends ArcjetReason {
    // Warning: (ae-forgotten-export) The symbol "ArcjetSensitiveInfoReasonInit" needs to be exported by the entry point index.d.ts
...
export class ArcjetShieldReason extends ArcjetReason {
    // Warning: (ae-forgotten-export) The symbol "ArcjetShieldReasonInit" needs to be exported by the entry point index.d.ts
...
// @public (undocumented)
const categories: Record<ArcjetBotCategory, readonly ArcjetWellKnownBot[]>;
export { categories as botCategories }
export { categories }
