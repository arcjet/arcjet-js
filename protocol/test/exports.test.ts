...
test("`@arcjet/protocol` public API", async function (t) {
  ...
  await t.test('should expose the value exports of "./client"', async function () {
  ...
  await t.test('should expose exactly the api surface of "./client"', async function () {
    const [declaration, documented] = await Promise.all([
  ...
  await t.test('should publish every value of "./client" as a value', async function () {
    const module = await import("@arcjet/protocol/client");
  ...
  await t.test('should expose the value exports of "./convert"', async function () {
  ...
  await t.test('should expose exactly the api surface of "./convert"', async function () {
    const [declaration, documented] = await Promise.all([
  ...
  await t.test('should publish every value of "./convert" as a value', async function () {
    const module = await import("@arcjet/protocol/convert");
  ...
  await t.test('should expose the value exports of "./well-known-bots"', async function () {
    const module = await import("@arcjet/protocol/well-known-bots");

    assert.deepEqual(new Set(Object.keys(module)), new Set(["categories"]));
  });

  await t.test('should expose exactly the api surface of "./well-known-bots"', async function () {
    const [declaration, documented] = await Promise.all([
  ...
  await t.test('should publish every value of "./well-known-bots" as a value', async function () {
    const module = await import("@arcjet/protocol/well-known-bots");
  ...
  await t.test('should expose the value exports of "./typeid"', async function () {
  ...
  await t.test('should expose exactly the api surface of "./typeid"', async function () {
    const [declaration, documented] = await Promise.all([
  ...
  await t.test('should publish every value of "./typeid" as a value', async function () {
    const module = await import("@arcjet/protocol/typeid");
  ...
  await t.test('should expose "./client.js" as an alias of "./client"', async function () {
    // The same module, not a copy of it: one set of module state behind both
    // entrypoints, so `instanceof` holds across them.
    assert.equal(
      await import("@arcjet/protocol/client.js"),
      await import("@arcjet/protocol/client"),
    );
  });

  await t.test('should expose "./convert.js" as an alias of "./convert"', async function () {
    // The same module, not a copy of it: one set of module state behind both
    // entrypoints, so `instanceof` holds across them.
    assert.equal(
  ...
  await t.test(
    'should expose "./well-known-bots.js" as an alias of "./well-known-bots"',
    async function () {
      // The same module, not a copy of it: one set of module state behind both
      // entrypoints, so `instanceof` holds across them.
      assert.equal(
  ...
  await t.test('should expose "./typeid.js" as an alias of "./typeid"', async function () {
    // The same module, not a copy of it: one set of module state behind both
    // entrypoints, so `instanceof` holds across them.
    assert.equal(
      await import("@arcjet/protocol/typeid.js"),
      await import("@arcjet/protocol/typeid"),
    );
  });
});
