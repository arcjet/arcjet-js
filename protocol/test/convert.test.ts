...
test("convert", async (t) => {
  await t.test("ArcjetModeToProtocol", async (t) => {
    ...
    await t.test("should turn unknown values into the `UNSPECIFIED` mode", () => {
      assert.equal(
        ArcjetModeToProtocol(
  ...
  await t.test("ArcjetEmailTypeToProtocol", async (t) => {
    ...
    await t.test("should turn `NO_GRAVATAR` into an email type", () => {
      assert.equal(ArcjetEmailTypeToProtocol("NO_GRAVATAR"), EmailType.NO_GRAVATAR);
    });

    await t.test("should turn `NO_MX_RECORDS` into an email type", () => {
      assert.equal(ArcjetEmailTypeToProtocol("NO_MX_RECORDS"), EmailType.NO_MX_RECORDS);
    });

    await t.test("should turn unknown values into the `UNSPECIFIED` email type", () => {
      assert.equal(
        ArcjetEmailTypeToProtocol(
          // @ts-expect-error
          "NOT_VALID",
  ...
  await t.test("ArcjetEmailTypeFromProtocol", async (t) => {
    await t.test("should turn a `DISPOSABLE` email type into a string", () => {
      assert.equal(ArcjetEmailTypeFromProtocol(EmailType.DISPOSABLE), "DISPOSABLE");
    });
    ...
    await t.test("should turn a `NO_GRAVATAR` email type into a string", () => {
      assert.equal(ArcjetEmailTypeFromProtocol(EmailType.NO_GRAVATAR), "NO_GRAVATAR");
    });

    await t.test("should turn a `NO_MX_RECORDS` email type into a string", () => {
      assert.equal(ArcjetEmailTypeFromProtocol(EmailType.NO_MX_RECORDS), "NO_MX_RECORDS");
    });
  ...
  await t.test("ArcjetStackToProtocol", async (t) => {
    ...
    await t.test("should turn a `FASTIFY` stack into an SDK stack", () => {
      assert.equal(ArcjetStackToProtocol("FASTIFY"), SDKStack.SDK_STACK_FASTIFY);
    });
    ...
    await t.test("should turn a `REACT_ROUTER` stack into an SDK stack", () => {
      assert.equal(ArcjetStackToProtocol("REACT_ROUTER"), SDKStack.SDK_STACK_REACT_ROUTER);
    });
    ...
    await t.test("should turn a `SVELTEKIT` stack into an SDK stack", () => {
      assert.equal(ArcjetStackToProtocol("SVELTEKIT"), SDKStack.SDK_STACK_SVELTEKIT);
    });
  ...
  await t.test("ArcjetConclusionFromProtocol", async (t) => {
    ...
    await t.test("should turn a `CHALLENGE` conclusion into a string", () => {
      assert.equal(ArcjetConclusionFromProtocol(Conclusion.CHALLENGE), "CHALLENGE");
    });
      ...
      const reason = ArcjetReasonFromProtocol(
        create(ReasonSchema, {
          reason: {
            case: "sensitiveInfo",
            value: {
              denied: [{ end: 16, identifiedType: "credit-card-number", start: 0 }],
            },
          },
        }),
      );
  ...
  await t.test("ArcjetReasonToProtocol", async (t) => {
    ...
    await t.test("should create a protocol reason from an arcjet rate limit reason", () => {
      assert.deepEqual(
        ArcjetReasonToProtocol(
    ...
    await t.test("should create a protocol reason from an arcjet bot reason", () => {
      assert.deepEqual(
        ArcjetReasonToProtocol(
          new ArcjetBotReason({
    ...
    await t.test("should create a protocol reason from an arcjet filter reason", () => {
      assert.deepEqual(
        ArcjetReasonToProtocol(
    ...
    await t.test("should create a protocol reason from an arcjet sensitive info reason", () => {
      assert.deepEqual(
        ArcjetReasonToProtocol(
    ...
    await t.test("should create a protocol reason from an arcjet edge rule reason", () => {
      assert.deepEqual(
    ...
    await t.test("should create a protocol reason from an arcjet shield reason", (t) => {
      assert.deepEqual(
    ...
    await t.test("should create a protocol reason from an arcjet error reason (string)", () => {
      assert.deepEqual(
    ...
    await t.test("should create a protocol reason from an arcjet error reason (error)", () => {
      assert.deepEqual(
  ...
  await t.test("ArcjetRuleResultToProtocol", async (t) => {
    await t.test("should create a protocol rule result from an arcjet rule result", () => {
      assert.deepEqual(
        ArcjetRuleResultToProtocol(
  ...
  await t.test("ArcjetRuleResultFromProtocol", async (t) => {
    await t.test("should create an arcjet rule result from a protocol rule result", () => {
      assert.deepEqual(
        ArcjetRuleResultFromProtocol(
          create(RuleResultSchema, {
            conclusion: Conclusion.ALLOW,
  ...
  await t.test("ArcjetDecisionToProtocol", async (t) => {
    await t.test("should create a protocol decision from an arcjet decision", () => {
      assert.deepEqual(
        ArcjetDecisionToProtocol(
  ...
  await t.test("ArcjetDecisionFromProtocol", async (t) => {
    ...
    await t.test("should create an arcjet error decision w/ empty proto", () => {
    ...
    await t.test("should create an arcjet allow decision w/ an allow conclusion proto", () => {
      const decision = ArcjetDecisionFromProtocol(
    ...
    await t.test("should create an arcjet deny decision w/ a deny conclusion proto", () => {
      const decision = ArcjetDecisionFromProtocol(
    ...
    await t.test("should create an arcjet error decision w/ an error conclusion proto", () => {
      const decision = ArcjetDecisionFromProtocol(
    ...
    await t.test("should create an arcjet error decision w/ an invalid conclusion proto", () => {
      const decision = ArcjetDecisionFromProtocol({
        // @ts-expect-error: test runtime behavior.
    ...
    await t.test("should create an arcjet error decision w/ an invalid proto", () => {
      const decision = ArcjetDecisionFromProtocol(
        // @ts-expect-error: test runtime behavior.
        "NOT_VALID",
      );
    ...
    await t.test("should create an arcjet decision w/ an IP detail proto (empty)", () => {
      const decision = ArcjetDecisionFromProtocol(
  ...
  await t.test("ArcjetRuleToProtocol", async (t) => {
    ...
    await t.test("should create a rate limit protocol rule (token bucket)", () => {
      const rule = ArcjetRuleToProtocol({
    ...
    await t.test("should create a rate limit protocol rule (fixed window)", () => {
      const rule = ArcjetRuleToProtocol({
    ...
    await t.test("should create a rate limit protocol rule (sliding window)", () => {
      const rule = ArcjetRuleToProtocol({
