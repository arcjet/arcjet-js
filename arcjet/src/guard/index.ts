...
export type { ArcjetDiagnosticLogger } from "./diagnostics.ts";
export type {
  ArcjetMetadata,
  Conclusion,
  Reason,
...
/** An Arcjet client for Guards, Captures, and their delivery lifecycle. */
export interface ArcjetClient {
...
/** Backwards-compatible name for the pre-unification Guard client. */
export type ArcjetGuard = ArcjetClient;
