...
## [1.1.0](https://github.com/arcjet/arcjet-js/compare/v1.0.0...arcjet-v1.1.0) (2026-01-30)
...
* The following workspace dependencies were updated
  * dependencies
    * @arcjet/analyze bumped from 1.0.0 to 1.1.0
    * @arcjet/cache bumped from 1.0.0 to 1.1.0
    * @arcjet/duration bumped from 1.0.0 to 1.1.0
    * @arcjet/headers bumped from 1.0.0 to 1.1.0
    * @arcjet/protocol bumped from 1.0.0 to 1.1.0
    * @arcjet/runtime bumped from 1.0.0 to 1.1.0
    * @arcjet/stable-hash bumped from 1.0.0 to 1.1.0
  * devDependencies
