...
test("`arcjet`: should expose the documented export paths", async function () {
...
test('`arcjet`: should expose the value exports of "."', async function () {
  const module = await import("arcjet");
...
test('`arcjet`: should expose exactly the api surface of "."', async function () {
...
test('`arcjet`: should publish every value of "." as a value', async function () {
  const module = await import("arcjet");
...
test("`arcjet`: should not republish another package's internals", async function () {
