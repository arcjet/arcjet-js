...
test("`@arcjet/transport`: should expose the documented export paths", async function () {
...
test('`@arcjet/transport`: should expose the value exports of "."', async function () {
  const module = await import("@arcjet/transport");

  assert.deepEqual(new Set(Object.keys(module)), new Set(["createTransport"]));
});

test('`@arcjet/transport`: should expose exactly the api surface of "."', async function () {
...
test('`@arcjet/transport`: should publish every value of "." as a value', async function () {
  const module = await import("@arcjet/transport");
...
test("`@arcjet/transport`: should not republish another package's internals", async function () {
